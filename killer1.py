...
jalan("\033[1;44m  ___ _    __   __  _  ___  ___ ")  
jalan("\033[1;44m ☞🐸  ČŁ𝐨ή𝑒尺 ⓕσ𝓡 𝐀𝕃𝐥 𝐂ㄖⓤ𝓝ᵗ𝓇ιᵉᔕ  🐲★")
jalan("\033[1;44m 🐹 𝐼𝒩𝒟𝐼𝒜𝒩 𝒰𝒮𝐸𝑅 𝒰𝒮𝐸 𝒜𝒩𝒴 𝒫𝑅☯𝒳𝒴 𝒯🍬 𝒞𝐿💞𝒩𝐸 🐹") 
jalan("\033[1;44m  🆆🅸🅵🅸 🆄🆂🅴🆁 🆄🆂🅴 🅰🅽🆈 🅿🆁🅾🆇🆈 🆃🅾 🅲🅻🅾🅽🅴 ") 
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Admin
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mYour Account is already in checkpoint & use another New Id...")
...
def menu():
	...
	print "   \033[1;36;40m      └─────────────────────────────────┘"
	print "\033[1;32;40m Type(1)\033[1;33;41mHack Accounts"	
	print "\033[1;32;40m"																														
	print "\033[1;32;40m Type(0) \033[1;33;43mLog out"
	pilih()
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			...
			print("\n\033[1;96m[!] \x1b[1;91mPassword/Email Invalid ")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def brute():
    ...
    try:
        ...
        try:
            ...
            print '\x1b[1;91m[!] File not found...'
            print """\n\x1b[1;91m[!] \x1b[1;92m Invalid wordlist Directoery """
            super()
