...
\033[1;93m       
\033[1;93m ╭──────────────────────────────────╮
\033[1;34;40m   `´. ₱ⱤØ₲Ɽ₳₥₥ɆⱤ : ₥Ɽ ₭łⱠⱠɆⱤ -'´.
\033[1;34;40m ✯ ʏօʊȶʊɮɛ : ʍʀ ӄɨʟʟɛʀ ɢǟʍɨռɢ ʐօռɛ 
\033[1;34;40m ✯ ◦•●◉✿ TikTok Ⓔ mrkillerpro1: ✿◉●•◦
\033[1;34;40m ✯    Ｗ.A : +923107104146 :
\033[1;93m ╰──────────────────────────────────╯ """
...
print  """
\033[1;93m     ___  ___                    _        
\033[1;93m    / __\/ __\   /\  /\__ _  ___| | _____ 
\033[1;93m   / _\ /__\//  / /_/ / _` |/ __| |/ / __|
\033[1;93m  / /  / \/  \ / __  / (_| | (__|   <\__ \
\033[1;93m  \/   \_____/ \/ /_/ \__,_|\___|_|\_\___/


\033[1;30,40m  🆄🅿🅳🅰🆃🅴🅳 🆅🅴🆁🆂🅸🅾🅽 🆅1.2 """

jalan("\033[1;96m◈────────────\033[1;99mKiller v1.2\033[1;99m────────────◈")                        
jalan("\033[1;96m Programmer : Ihtesham Jahangir (Mr Killer) ")  
jalan("\033[1;96m ☞🐸  ČŁ𝐨ή𝑒尺 ⓕσ𝓡 𝐀𝕃𝐥 𝐂ㄖⓤ𝓝ᵗ𝓇ιᵉᔕ  🐲★")
jalan("\033[1;96m 🐹 𝐼𝒩𝒟𝐼𝒜𝒩 𝒰𝒮𝐸𝑅 𝒰𝒮𝐸 𝒜𝒩𝒴 𝒫𝑅☯𝒳𝒴 𝒯🍬 𝒞𝐿💞𝒩𝐸 🐹") 
jalan("\033[1;30,40m  🆆🅸🅵🅸 🆄🆂🅴🆁 🆄🆂🅴 🅰🅽🆈 🅿🆁🅾🆇🆈 🆃🅾 🅲🅻🅾🅽🅴 ") 

jalan("\033[1;96m◈──────────\033[1;96mKiller v1.2\033[1;96m──────────◈")
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mYour Account is already in Checkpoint..")
...
def pilih_super():
	...
	if peak =="":
		...
		try:
			...
			super()
		print"\033[1;35;40m[✺] Fetching IDs..."
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							print '\x1b[1;36;40m[HACKED Successfully ] \x1b[1;97m ' + user  + ' \x1b[1;36;40m|\x1b[1;97m ' + pass2 + ' ⚡ ' + b['name']
							cek = open("out/CP.txt", "a")
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									print '\x1b[1;36;40m[HACKED Successfully] \x1b[1;97m ' + user  + ' \x1b[1;36;40m|\x1b[1;97m ' + pass3 + ' ⚡ ' + b['name']
									cek = open("out/CP.txt", "a")
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													print '\x1b[1;36;40m[HACKED Successfully ] \x1b[1;97m ' + user  + ' \x1b[1;36;40m|\x1b[1;97m ' + pass5 + ' ⚡ ' + b['name']
													cek = open("out/CP.txt", "a")
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															print '\x1b[1;36;40m[HACKED Successfully] \x1b[1;97m ' + user  + ' \x1b[1;36;40m|\x1b[1;97m ' + pass6 + ' ⚡ ' + b['name']
															cek = open("out/CP.txt", "a")
															...
															if 'access_token' in q:
																...
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[1;36;40m[HACKED Successfully] \x1b[1;97m ' + user  + ' \x1b[1;36;40m|\x1b[1;97m ' + pass7 + ' ⚡ ' + b['name']
																	cek = open("out/CP.txt", "a")
...
def brute():
    ...
    try:
        ...
        try:
            ...
            print """\n\x1b[1;91m[!] \x1b[1;92mInvalid wordlist"""
            super()
